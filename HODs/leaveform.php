    ...
    <div class="main-content">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], $file_path)) {
                ...
                $sql = "INSERT INTO faculty1 (Name, id, department, LType, start, end, ndays, reason, hod, file)
                        VALUES ('$name', '$id', '$department', '$leaveType', '$startDate', '$endDate', '$numDays', '$reason', '$hod', '$file_path')";
