...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2023 at 05:34 PM
...
INSERT INTO `faculty1` (`application_id`, `name`, `id`, `department`, `LType`, `shift`, `start`, `end`, `ndays`, `reason`, `hod`, `H_feedback`, `aqict`, `IC_Feedback`, `principal`, `Pn_feedback`, `file`, `next_form`, `RegDate`, `Academic_year`) VALUES
