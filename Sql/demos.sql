...
(2, 'dpj', '01fcs101', 'computer science', 'ML', 1, '2023-06-21', '2023-06-22', 2, 'fever', 1, '', 1, '', 1, '', '../assets/assetsSheep.pdf', 1, '2023-06-20 16:00:54', ''),
...
(66, 'Dr.S.DENIS AROCKIARAJ', '01FCH17', 'Chemistry', 'CL', 1, '2023-09-24', '2023-09-26', 3, 'function', 1, '', 1, '', 1, '', '../assets/assetsUNIT 1 - EVS INTRODUCTION.pdf', 3, '2023-09-25 04:41:33', '2023-2024'),
(67, 'Dr.M.THIAGARAJAN', '01FMA15', 'MATHEMATICS', 'OD', 1, '2023-09-24', '2023-09-25', 2, 'important works', 1, '', 1, '', 1, '', '../assets/assetsFcFIoCaJ-6342.pdf', 3, '2023-09-25 04:48:45', '2023-2024'),
(68, 'Dr.I.JOHNSON', '01FPH16', 'Physics', 'CL', 1, '2023-09-24', '2023-09-26', 3, 'Health Issue', 1, '', 1, '', 1, '', '../assets/assetsUNIT 1 - EVS INTRODUCTION.pdf', 3, '2023-09-25 04:53:29', '2023-2024'),
(69, 'Dr.V.FRANCIS', '06FEN24', 'English', 'OD', 1, '2023-09-24', '2023-09-25', 2, 'lecture', 1, '', 1, '', 1, '', '../assets/assetsAdobe Scan Nov 27, 2020.pdf', 3, '2023-09-25 05:00:18', '2023-2024'),
(70, 'Dr.B.Kanickairaj', '01FPH18', 'ELECTRONICS', 'CL', 1, '2023-09-24', '2023-09-25', 2, 'important works', 3, '', 3, '', 3, '', '../assets/assetspython operators.pdf', 3, '2023-09-25 05:04:33', '2023-2024'),
(71, 'Dr.M.SUVAKKIN', '07FEC01', 'Economics', 'CL', 1, '2023-09-24', '2023-09-25', 2, 'important works', 1, '', 1, '', 1, '', '../assets/assetsU19TCC303TB1 tamil one word.pdf', 3, '2023-09-25 05:09:04', '2023-2024'),
(72, 'Mr.D.MARIA ANTONY', '07FCM01', 'commerce', '', 1, '2023-09-24', '2023-09-25', 2, 'casual', 3, '', 3, '', 3, '', '../assets/assetsAdobe Scan Nov 27, 2020.pdf', 3, '2023-09-25 05:11:27', '2023-2024');
...
--
ALTER TABLE `faculty1`
  MODIFY `application_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
